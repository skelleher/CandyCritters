...
#define SESSION_FILE_PREFIX  @"s_"   // The prefix denoting a sesion a file.
...
- (void)UploaderThread:(NSString *)localyticsFilePath {
	...
	// 2) if an uplad file already exists, append the data.
